...
| `dart-gen` | `acme_gen` | private (`publish_to: none`) | a library whose build_runner part exists only under `.dart_tool/build/generated/acme_gen/lib/` (committed; `.gitignore` re-includes that dir); `lib/bindings.dart`, generated by its header only |
