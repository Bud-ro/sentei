 ...
 * adapter (scip-dart.ts) runs the same sniff over its documents.
 */
const GENERATED_HEADERS: readonly RegExp[] = [
  /@generated|automatically generated|auto[- ]generated|do not edit|do not modify by hand/i,
  /generated by /i,
 ...
 */
export function isGeneratedFile(abs: string, repoRel: string, pkgPath?: string, head?: string): boolean {
