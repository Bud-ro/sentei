...
describe('pubspec_overrides.yaml writer', () => {
  ...
  it('the generated-header sniff reads the leading comments of a Dart file, not its doc comments', () => {
    const f = path.join(root, 'header.dart');
    const gen = (body: string): boolean => {
      writeFileSync(f, body);
      return isGeneratedDartFile(f, 'lib/header.dart', '.');
    };
    expect(gen('// GENERATED CODE - DO NOT MODIFY BY HAND\n\npart of \'x.dart\';\n')).toBe(true);
    expect(gen('// Copyright (c) 2025.\n\n// AUTO GENERATED FILE, DO NOT EDIT.\n//\n// Generated by `package:ffigen`.\nimport \'dart:ffi\';\n')).toBe(true);
    // dart-lang/samples command_line/lib/src/options.dart: a doc comment below the imports.
    expect(gen("// Copyright.\n\nimport 'package:args/args.dart';\n\n/// The command line argument parser generated by the `build_cli_annotations`\n/// package.\nint parser = 1;\n")).toBe(false);
    // Block comments are part of the header (round 7), and do not end it.
    expect(gen('/* see below */\n// DO NOT EDIT\n')).toBe(true);
    expect(gen('/*\n * Copyright.\n */\n\n/* Generated code. Do not modify. */\nlibrary;\n')).toBe(true);
    // protoc-gen-dart (dart-lang/labs appengine `*.pbgrpc.dart`, also matched by path).
    expect(gen('//\n//  Generated code. Do not modify.\n//  source: google/appengine/v1/appengine.proto\n//\n// @dart = 2.12\n\nimport \'dart:async\' as $async;\n')).toBe(true);
    // package:web: the generator line is in the SECOND comment block, after the license.
    const license = '// Copyright (c) 2026, the Dart project authors.\n// BSD-style license.\n//\n// API docs from MDN.\n';
    expect(gen(`${license}\n// Generated from Web IDL definitions.\n\n// ignore_for_file: unnecessary_ignore\n\n@JS()\nlibrary;\n`)).toBe(true);
    // ... however long the license is (the TypeScript sniff stops after 20 lines).
    expect(gen(`${'// license line\n'.repeat(30)}\n// Generated from Web IDL definitions.\nlibrary;\n`)).toBe(true);
    // Negative: hand-written files whose doc comments mention generated code.
    expect(gen('// Copyright.\n\n/// Generated code. Do not modify.\nclass A {}\n')).toBe(false);
    expect(gen('// Copyright.\n\n/**\n * Generated from Web IDL, do not edit.\n */\nclass A {}\n')).toBe(false);
    expect(gen('/// This library is generated by build_cli.\nlibrary;\n\n// DO NOT EDIT below.\n')).toBe(false);
    // A header line after the first code token does not count.
    expect(gen("import 'x.dart';\n// Generated code. Do not modify.\n")).toBe(false);
    expect(dartFileHeader(path.join(root, 'missing.dart'))).toBe('');
  });
