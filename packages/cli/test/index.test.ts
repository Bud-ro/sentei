...
describe('unjs final round (scope, SFC, generated files, heap retry, nuxt)', () => {
  ...
  it('detects generated files from header comments of any comment syntax, and tool-output dirs', () => {
    ...
    // Dart generators (the scip-dart adapter runs the same sniff): source_gen / build_runner,
    // ffigen and jnigen headers.
    expect(gen('api.dart', '// GENERATED CODE - DO NOT MODIFY BY HAND\n\npart of \'api.dart\';\n')).toBe(true);
    expect(gen('ffi.dart', '// Part of the LLVM Project.\n\n// AUTO GENERATED FILE, DO NOT EDIT.\n//\n// Generated by `package:ffigen`.\n')).toBe(true);
    expect(gen('jni.dart', '// AUTO GENERATED BY JNIGEN 1.0.1. DO NOT EDIT!\n')).toBe(true);
    expect(gen('hand.dart', '// Parses generated code; keep it by hand.\nint a = 1;\n')).toBe(false);
    // Round 7: protoc-gen-dart and package:web (Web IDL) headers.
    expect(gen('svc.dart', '//\n//  Generated code. Do not modify.\n//  source: svc.proto\n')).toBe(true);
    expect(gen('dom.dart', '// Generated from Web IDL definitions.\n')).toBe(true);
    expect(gen('idl.ts', '// generated from the WebGPU IDL by webidl2ts\n')).toBe(true);
    expect(gen('prose.dart', '// Reads the IDL; the bindings are generated elsewhere.\n')).toBe(false);
